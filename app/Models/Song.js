export default class Song {
  ...
  get Template() {
    return `
    <div class="card" style="width: 18rem;" onclick="app.songsController.setActive(${this.id})">
  ...
  get playlistTemplate() {
    ...
    <div class="card-body">
      <h5 class="card-title">${this.artist} | ${this.title}</h5>
      <button type="button" class="btn btn-outline-danger" onclick="app.songsController.removeSong('${this.id}')">Remove</button>
    </div>
    </div>
        `;
  }
